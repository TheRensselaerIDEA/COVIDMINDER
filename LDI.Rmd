...
labels <- sprintf(
  "<strong>%s</strong><br/>
  Older At Risk Adults DI: %g<br/>
  At Risk Adults DI: %g<br/>
  Total Tests DI: %g<br/>
  <span style='background-color: #e1eaea'>Hospital Beds DI: %g</span>",
  states$NAME, states$older_at_risk_ldi, states$at_risk_ldi, states$tests_ldi, states$hosp_beds_ldi
...
labels2 <- sprintf(
  "<strong>%s</strong><br/>
  Older At Risk Adults DI: %g</span><br/>
  At Risk Adults DI: %g<br/>
...
labels4 <- sprintf(
  "<strong>%s</strong><br/>
  <span style='background-color: #e1eaea'>Older At Risk Adults DI: %g</span><br/>
  At Risk Adults DI: %g<br/>
  Total Tests DI: %g<br/>
  Hospital Beds DI: %g",
  states$NAME, states$older_at_risk_ldi, states$at_risk_ldi, states$tests_ldi, states$hosp_beds_ldi
...
m4 <- m4 %>% addPolygons(
  fillColor = ~pal4(older_at_risk_ldi),
  weight = 2,
  opacity = 1,
  color = "white",
  dashArray = "3",
  ...
  addLegend(pal = pal4, values = ~older_at_risk_ldi, opacity = 0.7, title = "Disparity Index<br/>Share of Older At Risk Adults",
  position = "bottomright")
