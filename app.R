      ...
      tabPanel(title = HTML("<b>NATIONAL REPORT CARD</b>"),
              ...
              fluidRow(
               ...
               fluidRow(column(8, style="text-align:center;",
                               ...
                               offset=2)),
              fluidRow(column(8, style="text-align:center;position:relative;",uiOutput("US.trends.title"),
                               ...
                               plotOutput(outputId = "US.trends", 
                                          ...
                                          brush = brushOpts(
                                            id = "trends.brush",
                                            resetOnNew = TRUE)),
                               uiOutput("US.trends.tooltip"), offset = 2),

                        column(2, downloadButton("US.trends.dl", label="Download Case Trend Plot"), offset = 8)),
               tags$br(),
...
downloadButton("US.map.cases.dl", label="Download Case Map"),
 ...
 downloadButton("US.maps.testing.dl", label="Download Testing Map"), offset = 2
                               )),
               tags$br(),
               fluidRow(column(8, style="text-align:center;",
                               uiOutput("US.determinant.title"), offset=2),
                        column(8, align="center", plotOutput(outputId = "US.determinants", 
                                              ),
                        offset=2),
                        column(2, downloadButton("US.determinants.dl", label="Download Determinants Visualization"), offset=8)
               ),
               tags$br(),
               tags$br(),
               fluidRow(column(8, style="text-align:center;",
     ...
     tabPanel(title = HTML("<div><b>STATE REPORT CARDS</b></div>"),
               value = "state_report_cards",
                    ...
                    fluidRow(column(8,
                                    ...
                                    offset=2)),
                    fluidRow(column(8, style="text-align:center;",uiOutput("main_title"),
                                    offset=2)),
                    tags$br(),
                    fluidRow(column(8, style="text-align:center;",
                                    ...
                                    offset=2)),
                   fluidRow(column(8, style="text-align:center;position:relative;",uiOutput("state.CoT.title"),
                                    ...
                                    offset=2),
                             column(2, downloadButton("state.CoT.dl", label="Download Case Barplot"),offset = 8),
                             column(8, style="text-align:center;position:relative;",uiOutput("state.DoT.title"),
                                    ...
                                    offset=2)),
                             column(2, downloadButton("state.DoT.dl", label="Download Mortality Barplot"), offset = 8),
                    fluidRow(column(8, style="text-align:center;",
                                    tags$h2("Flattening the Curve"),
                                    tags$p("Nationwide, states have taken various approaches to mitigate the spread of coronavirus, such as social distancing interventions and encouraging mask use where social distancing is not possible. Studies by the CDC have shown these methods reduce new COVID-19 cases, hospitalizations, and deaths."),
                                    tags$b("Data Source: "), tags$a("CDC", href="https://wwwnc.cdc.gov/eid/article/26/8/20-1093_article"), offset=2)),
                    ...
                    fluidRow(column(8, style="text-align:center;",
                                    ...
                                    offset=2)),
                    fluidRow(column(8, style="text-align:center;position:relative;",uiOutput("state.trends.title"),
                                    ...
                                    offset=2)),
                             column(2, downloadButton("state.trends.dl", label="Download Case Trends Plot"), offset = 8),
                    tags$br(),
                    fluidRow(column(8, style="text-align:center;",
                                    tags$div(class = "info",
                                             HTML("<h2>Disparity Color Legend</h2>
...
downloadButton("map.deaths.dl", label="Download Mortality Map"),
                    ...
                    tags$br(),
                    fluidRow(column(8, style="text-align:center;",
                                    tags$h1("Comorbidities"),offset=2)),
                    fluidRow(column(8, style="text-align:center;",
                                    uiOutput("determinant.title"),offset=2),
                             column(8,
...
downloadButton("map.determinant.dl", label="Download Determinant Map"), offset = 2),
                             column(8, style="text-align:center;",
