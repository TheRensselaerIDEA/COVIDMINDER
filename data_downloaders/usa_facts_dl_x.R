...
#todays.raw.case.data <- todays.raw.case.data[1:170]
todays.raw.case.data <- todays.raw.case.data[1:346]
todays.raw.death.data <- read_csv(paste0(file.dir,death.file))
#todays.raw.death.data <- todays.raw.death.data[1:170]
todays.raw.death.data <- todays.raw.death.data[1:346]
