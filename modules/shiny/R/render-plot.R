...
# MANUAL CHANGES - JOSE
# - Added aditional function parameter 'alt', to be added as an alt tag for output
# - interactive graph.
renderPlot <- function(expr, width='auto', height='auto', res=72, alt = "", ...,
...
drawPlot <- function(name, session, func, width, height, pixelratio, res, alt, ...) {
  #  1. Start PNG
