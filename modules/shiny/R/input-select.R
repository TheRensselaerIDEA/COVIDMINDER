...
# MANUAL CHANGES - JOSE
# - Added an additional parameter, title, which adds an aditional title parameter
# - to selectize tool. This is a workaround for missing label ADA error.
selectInput <- function(inputId, label, choices, title = NULL, selected = NULL,
