...
renameDeterminants <- function(determinant.data){

  determinant.data$y[determinant.data$y == "Average Daily PM2.5"] <- "Avg. Daily Air Pollution (PM2.5)"
  determinant.data$y[determinant.data$y == "Average Number of Physically Unhealthy Days"] <- "Avg. Number of Physically Unhealthy Days"
  determinant.data$y[determinant.data$y == "Cancer.death_rate"] <- "Cancer Death Rate"
  determinant.data$y[determinant.data$y == "% Vaccinated"] <- "% Influenza Vaccinated Medicare FFS"
  determinant.data$y[determinant.data$y == "Suicide Rate (Age-Adjusted)"] <- "Age-Adjusted Suicide Rate"
  determinant.data$y[determinant.data$y == "Average Grade Performance"] <- "Avg. Reading Grade Performance"
  determinant.data$y[determinant.data$y == "Overcrowding"] <- "% of County with Overcrowded Housing"
  determinant.data$y[determinant.data$y == "% Uninsured"] <- "% of County Uninsured"
  determinant.data$y[determinant.data$y == "% Frequent Mental Distress"] <- "% Frequently Mentally Distressed"
  determinant.data$y[determinant.data$y == "mean_winter_temp"] <- "Mean Winter Temperature"
  determinant.data$y[determinant.data$y == "mean_summer_temp"] <- "Mean Summer Temperature"
  determinant.data$y[determinant.data$y == "mean_winter_rm"] <- "Mean Winter Relative Humidity"
  determinant.data$y[determinant.data$y == "mean_summer_rm"] <- "Mean Summer Relative Humidity"
  determinant.data$y[determinant.data$y == "PediatricAsthma"] <- "% of County with Pediatric Asthma"
  determinant.data$y[determinant.data$y == "% less than 18 years of age"] <- "% less than 18 Years of Age"
  determinant.data$y[determinant.data$y == "Case.Fatality_Ratio"] <- "COVID-19 Case Fatality Ratio"
  determinant.data$y[determinant.data$y == "Incidence_Rate"] <- "COVID-19 Incidence Rate"
  determinant.data$y[determinant.data$y == "Active"] <- "Number of Active COVID-19 Cases"
  determinant.data$y[determinant.data$y == "Lat"] <- "Latitude"
  determinant.data$y[determinant.data$y == "Long_"] <- "Longitude"
  determinant.data$y[determinant.data$y == "Confirmed"] <- "Number of Confirmed COVID-19 Cases"
  determinant.data$y[determinant.data$y == "Deaths"] <- "Number of COVID-19 Deaths"
  determinant.data$y[determinant.data$y == "Recovered"] <- "Number of People Recovered from COVID-19"
  determinant.data$y[determinant.data$y == "poverty"] <- "% Living in Poverty"
  determinant.data$y[determinant.data$y == "popdensity"] <- "Population Density"
  determinant.data$y[determinant.data$y == "medianhousevalue"] <- "Median House Value"
  determinant.data$y[determinant.data$y == "pcc_owner_occ"] <- "% Owner-Occupied Housing"
  determinant.data$y[determinant.data$y == "education"] <- "% with less than High-School Education"
  determinant.data$y[determinant.data$y == "population"] <- "Overall Population"
  determinant.data$y[determinant.data$y == "pct_blk"] <- "% African American in County"
  determinant.data$y[determinant.data$y == "hispanic"] <- "% Hispanic in County"
  determinant.data$y[determinant.data$y == "pct_asian"] <- "% Asian in County"
  determinant.data$y[determinant.data$y == "pct_native"] <- "% Native American in County"
  determinant.data$y[determinant.data$y == "pct_white"] <- "% White in County"
  determinant.data$y[determinant.data$y == "q_popdensity"] <- "Population Density"
  determinant.data$y[determinant.data$y == "older_pecent"] <- "% of Population Age 65+"
  determinant.data$y[determinant.data$y == "young_pecent"] <- "% of Population Ages 0-14"
  determinant.data$y[determinant.data$y == "prime_pecent"] <- "% of Population Ages 15-44"
  determinant.data$y[determinant.data$y == "mid_pecent"] <- "% of Population Ages 45-64"
  determinant.data$y[determinant.data$y == "Average Number of Mentally Unhealthy Days"] <- "Avg. Number of Mentally Unhealthy Days"
  determinant.data$y[determinant.data$y == "pct_obesity"] <- "% of Adults with Obesity"
  determinant.data$y[determinant.data$y == "80th Percentile Income"] <- "80th Percentile for Median Household Income"
  determinant.data$y[determinant.data$y == "20th Percentile Income"] <- "20th Percentile for Median Household Income"
  determinant.data$y[determinant.data$y == "mean_pm25"] <- "Average Air Quality (PM2.5)"
  determinant.data$y[determinant.data$y == "pre_covid_deaths"] <- "Deaths before COVID-19 Infection"
  determinant.data$y[determinant.data$y == "pre_covid_death_rate"] <- "Death Rate before COVID-19 Infection"
  determinant.data$y[determinant.data$y == "child_deaths"] <- "Number of Children Deaths Under Age of 18"
  determinant.data$y[determinant.data$y == "infant_deaths"] <- "Number of Infant Deaths"
  determinant.data$y[determinant.data$y == "pct_diabetes"] <- "% of County with Diabetes"
  determinant.data$y[determinant.data$y == "# Food Insecure"] <- "# Food Insecurity"
  determinant.data$y[determinant.data$y == "% Food Insecure"] <- "% Food Insecurity"
  determinant.data$y[determinant.data$y == "# Limited Access"] <- "# Limited Access to Healthy Foods"
  determinant.data$y[determinant.data$y == "# Uninsured_1"] <- "# of Adults Under 65 with No Health Insurance"
  determinant.data$y[determinant.data$y == "% Uninsured_1"] <- "% of Adults Under 65 with No Health Insurance"
  determinant.data$y[determinant.data$y == "# Uninsured_2"] <- "# of Children with No Health Insurance"
  determinant.data$y[determinant.data$y == "% Uninsured_2"] <- "% of Children with No Health Insurance"
  determinant.data$y[determinant.data$y == "Average Grade Performance_1"] <- "Avg. Math Grade Performance"
  determinant.data$y[determinant.data$y == "Segregation index"] <- "Segregation Index Between Black and White"
  determinant.data$y[determinant.data$y == "Segregation Index"] <- "Segregation Index Between Non-White and White"
  determinant.data$y[determinant.data$y == "suicide_deaths"] <- "# of Suicide Deaths"
  determinant.data$y[determinant.data$y == "Crude Rate"] <- "Not Adjusted Suicide Rate"
  determinant.data$y[determinant.data$y == "Denominator"] <- "Estimated Number of Juveniles"
  determinant.data$y[determinant.data$y == "Average Traffic Volume per Meter of Major Roadways"] <- "Avg. Traffic Volume per Meter of Major Roadways"
  determinant.data$y[determinant.data$y == "pct_age65"] <- "% of Adults Age 65+"
  determinant.data$y[determinant.data$y == "All.Cause.death_rate"] <- "All Cause Death Rate"
  determinant.data$y[determinant.data$y == "Assault.death_rate"] <- "Assault Death Rate"
  determinant.data$y[determinant.data$y == "Cardiovascular.death_rate"] <- "Cardiovascular Disease Death Rate"
  determinant.data$y[determinant.data$y == "Despair.death_rate"] <- "Despair Death Rate"
  determinant.data$y[determinant.data$y == "AdultAsthma"] <- "% of County with Adult Asthma"
  determinant.data$y[determinant.data$y == "COPD"] <- "% of County with COPD"
  determinant.data$y[determinant.data$y == "AdultChronicLungDisease"] <- "% of County with Adult Chronic Lung Disease"
  determinant.data$y[determinant.data$y == "LungCancer"] <- "% of County with Lung Cancer"
