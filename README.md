...
### Local Installation
To deploy locally, clone the repository and run app.R on RStudio. On the source code pane, simply select Run App on the top right corner. <img src=https://raw.githubusercontent.com/TheRensselaerIDEA/COVIDMINDER/readme/runapp.png style="height:10px;">
